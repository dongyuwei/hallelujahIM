...
3. Instant translation when you typing the word(translate to Chinese right now, but the translation dictionary can be configured).
4. hallelujahIM is also a __Text-Expander__: it will load the file `~/.you_expand_me.json` in your Home directory. You can define your favorite substitutions, such as `{"te":"text expander", "yem":"you expand me"}`. 
