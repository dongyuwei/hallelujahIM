...
7. The right **Command** key cycles through three input modes: intelligent English → Pinyin → traditional English (raw, keys pass straight through to the app) → back to intelligent English.
